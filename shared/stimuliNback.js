...
function setArrays (){
  ...
  function defineEasyBack() {
    nbackStimuli.practiceListEasy_flanker = ["B", "P", "K", "K", "H", "M", "Q", "Q", "X", "N"];
    ...
    nbackStimuli.stimuliListEasy_flanker = ["K", "R", "N","P","H", "B","B","T", "H", "H",  "X", "K", "M", "K", "K", "P",  "P",  "B", "X", "M", "X", "X", "R", "Q", "N", "H", "P", "Q", "Q","H", "P", "B", "N", "M", "M","B", "K", "M", "Q", "X", "N",  "N", "T", "R", "R", "T", "T", "R", "T", "Q", "T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M"];
    nbackStimuli.practiceListEasy_span = ["B", "P", "K", "K", "H", "M", "Q", "Q", "X", "N"];
    nbackStimuli.stimuliListEasy_span = ["K", "R", "N","P","H", "B","B","T", "H", "H",  "X", "K", "M", "K", "K", "P",  "P",  "B", "X", "M", "X", "X", "R", "Q", "N", "H", "P", "Q", "Q","H", "P", "B", "N", "M", "M","B", "K", "M", "Q", "X", "N",  "N", "T", "R", "R", "T", "T", "R", "T", "Q", "T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M"]
  }
  
  function defineHard2Back() {
    nbackStimuli.practiceListHard_flanker = ["B", "K", "P", "K", "H", "Q", "M", "Q", "X", "N"];
    ...
    nbackStimuli.stimuliListHard_flanker = ["T", "B", "T", "B", "Q", "P", "T", "M", "K", "M", "K", "X", "Q", "K", "B", "H", "Q", "P", "Q", "H", "N", "N", "H", "H", "B", "M", "R", "M", "P", "R", "P", "T", "X", "K", "N", "P", "N", "X", "M", "R", "T", "R", "B", "Q", "H", "X", "R", "X", "K", "N", "T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M"];
    nbackStimuli.practiceListHard_span = ["B", "K", "P", "K", "H", "Q", "M", "Q", "X", "N"];
    nbackStimuli.stimuliListHard_span = ["T", "B", "T", "B", "Q", "P", "T", "M", "K", "M", "K", "X", "Q", "K", "B", "H", "Q", "P", "Q", "H", "N", "N", "H", "H", "B", "M", "R", "M", "P", "R", "P", "T", "X", "K", "N", "P", "N", "X", "M", "R", "T", "R", "B", "Q", "H", "X", "R", "X", "K", "N", "T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M"]
  }
  
  function defineHard3Back() {
    console.log("function defineHard3Back runs")
    nbackStimuli.practiceListHard_flanker = ["B", "K", "P", "H", "K", "Q", "M", "X", "Q", "N"];
    ...
    nbackStimuli.stimuliListHard_flanker = ["T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M", "R", "Q", "X", "K", "B", "R", "X", "B", "P", "H", "M", "T", "H", "M", "N", "K", "X", "N", "R", "X", "T", "K", "P", "T", "M", "B", "Q", "B", "N", "H", "N", "H", "R", "B", "Q", "R", "N", "T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M"];
    nbackStimuli.practiceListHard_span = ["B", "K", "P", "H", "K", "Q", "M", "X", "Q", "N"];
    nbackStimuli.stimuliListHard_flanker_span = ["T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M", "R", "Q", "X", "K", "B", "R", "X", "B", "P", "H", "M", "T", "H", "M", "N", "K", "X", "N", "R", "X", "T", "K", "P", "T", "M", "B", "Q", "B", "N", "H", "N", "H", "R", "B", "Q", "R", "N", "T", "P", "H", "M", "P", "K", "X", "Q", "K", "P", "Q", "T", "M"]
  }
